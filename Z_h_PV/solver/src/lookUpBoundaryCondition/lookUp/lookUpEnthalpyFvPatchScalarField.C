...
void Foam::lookUpEnthalpyFvPatchScalarField::updateCoeffs()
{
    ...
    forAll(h0_, facei)
    {
        //controlVariablesPtr[0] = const_cast<scalar*>(&(patch().lookupPatchField<volScalarField, scalar>("Z")[facei]));
        //controlVariablesPtr[1] = const_cast<scalar*>(&(patch().lookupPatchField<volScalarField, scalar>("h")[facei]));
        //controlVariablesPtr[2] = const_cast<scalar*>(&(patch().lookupPatchField<volScalarField, scalar>("PV")[facei]));
        controlVariablesPtr[0] = const_cast<scalar*>(&(patch().lookupPatchField<volScalarField, scalar>("PV")[facei]));
        controlVariablesPtr[1] = const_cast<scalar*>(&(patch().lookupPatchField<volScalarField, scalar>("h")[facei]));
        controlVariablesPtr[2] = const_cast<scalar*>(&(patch().lookupPatchField<volScalarField, scalar>("Z")[facei]));
